...
export const useTrackerProgressive = (trackerId: string) => {
  ...
  }, [tracker, trackerId, now, refreshToken]);
  ...
  const activeReminders = useMemo((): ProgressiveReminder[] => {
    ...
    return all;
  }, [tracker, predictiveReminders, trackerId, refreshToken]);
  ...
  }, [trackerConfig, userSavedTemplates, trackerId, correlations, tracker, refreshToken]);
