...
export default function OnboardingScreen({ navigation }: Props) {
  ...
  // NEW: Get auth context to mark onboarding as seen
  ...
  // FIXED: Navigate to Login and mark onboarding as seen
  const handleNavigateToLogin = useCallback(async () => {
    ...
    // NEW: Mark onboarding as seen in AuthContext
    await markOnboardingSeen();
    
    navigation.replace('Login');
  }, [isNavigating, navigation, markOnboardingSeen]);
  ...
  const scrollToNext = useCallback(() => {
    ...
    if (nextIndex < ONBOARDING_DATA.length) {
      ...
      resumeTimerRef.current = setTimeout(() => {
        if (!isNavigating) setIsAutoPlaying(true);
      }, USER_INACTIVITY_RESUME);
    } else {
      handleNavigateToLogin();
    }
  }, [currentIndex, isNavigating, handleNavigateToLogin]);
          ...
          <View style={[styles.card, isDark && styles.cardDark]}>
            ...
            >
              ...
              <View style={[
                styles.decorCircle, 
                { 
                  backgroundColor: currentColors[1] + '15', 
                  bottom: 40, 
                  right: 40, 
                  width: 70, 
                  height: 70 
              ...
              <View style={[
                styles.decorCircle, 
                { 
                  backgroundColor: currentColors[0] + '10', 
                  top: '50%', 
                  left: '10%', 
                  width: 30, 
                  height: 30 
  ...
  const currentColors = isDark && currentSlide.darkColors 
    ? currentSlide.darkColors 
    : currentSlide.colors;
    ...
    <SafeAreaView style={[styles.container, isDark && styles.containerDark]}>
      ...
      {!isLastSlide && !isNavigating && (
        ...
        >
          <BlurView 
            ...
            style={[styles.skipBlur, isDark && styles.skipBlurDark]}
      ...
      <View style={styles.paginationContainer}>
        ...
        <Text style={[styles.pageIndicator, isDark && styles.pageIndicatorDark]}>
          {currentIndex + 1} 
          <Text style={[styles.pageIndicatorTotal, isDark && styles.pageIndicatorTotalDark]}>
