import { StyleSheetActionSheetIOS, ActivityIndicator, Alert ,Button, Dimensions ,Image, Modal ,RefreshControl, ScrollView, Settings, Switch, TextInput, TouchableOpacity ,useColorScheme, View } from 'react-native';;
