import { StyleSheetActionSheetIOS ActivityIndicator Alert Animated Button Dimensions Image Modal RefreshControl ScrollView Settings Switch TextInput TouchableOpacity useColorScheme View } from 'react-native';;
...
showAlert(
  ...
  const renderOverview = () => (
    <Animated.View entering={FadeInUp} style={styles.tabPanel}>
      ...
      <View style={styles.sectionHeader}>
        ...
        <TouchableOpacity style={styles.seeAllButton} onPress={() => navigation.navigate('FamilySettings' as never)}>
      ...
      <View style={styles.sectionHeader}>
        ...
        <TouchableOpacity style={styles.seeAllButton} onPress={() => navigation.navigate('Timeline' as never, { babyId: currentBabyData?.id } as never)}>
  ...
  const renderHealthForm = () => (
    <Animated.View entering={FadeInUp} style={styles.tabPanel}>
      ...
      <GlassmorphismCard style={styles.actionCard} intensity={80} delay={400} onPress={() => navigation.navigate('Timeline' as never, { type: 'medication' } as never)}>
      ...
      <GlassmorphismCard style={styles.actionCard} intensity={80} delay={500} onPress={() => navigation.navigate('Timeline' as never, { type: 'sleep' } as never)}>
        <View style={styles.actionRow}>
      ...
      <GlassmorphismCard style={styles.actionCard} intensity={80} delay={600} onPress={() => navigation.navigate('Timeline' as never, { type: 'feed' } as never)}>
        <View style={styles.actionRow}>
      ...
      <GlassmorphismCard style={styles.actionCard} intensity={80} delay={700} onPress={() => navigation.navigate('GrowthDashboard' as never, { babyId: currentBabyData?.id } as never)}>
        <View style={styles.actionRow}>
