import { StyleSheet, ActivityIndicator, Dimensions, Image, LogBox, Modal, RefreshControl, ScrollView, Share, Switch, TextInput, TouchableOpacity, useColorScheme, View } from 'react-native';
