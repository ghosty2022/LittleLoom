...
import { AlertAnimated, Button, Dimensions, Image, Linking, Modal, Platform, ScrollView, Settings, Share, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';;
