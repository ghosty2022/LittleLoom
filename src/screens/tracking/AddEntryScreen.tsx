...
import {  ActivityIndicator, AlertAnimated, Button, Dimensions, KeyboardAvoidingView, Modal, Platform, Pressable, ScrollView, StatusBar, StyleSheet, Switch, Text, TouchableOpacity, type TextStyle, type ViewStyle, View } from 'react-native';;
